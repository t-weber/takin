...
echo -e "Depends: libstdc++6, libboost-system1.65.1 (>=1.65.1), libboost-filesystem1.65.1 (>=1.65.1), libboost-iostreams1.65.1 (>=1.65.1), libboost-regex1.65.1 (>=1.65.1), libboost-program-options1.65.1 (>=1.65.1), libboost-python1.65.1 (>=1.65.1), libqtcore4 (>=4.8.0), libqtgui4 (>=4.8.0), libqt4-opengl (>=4.8.0), libqt4-svg (>=4.8.0), libqt4-xml (>=4.8.0), libqwt6abi1 (>=6.1.0), libpython2.7 (>=2.7.0), libfreetype6\n" >> ${INSTDIR}/DEBIAN/control
